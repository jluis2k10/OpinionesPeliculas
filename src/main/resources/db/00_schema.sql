...
(
  ...
  SENTIMENT_MODEL bigint,
  SOURCE varchar(50) NOT NULL,
  SOURCE_CLASS varchar(255) NOT NULL,
  SUBJECTIVITY_ADAPTER varchar(255),
  SUBJECTIVITY_MODEL bigint,
  TERM varchar(255) NOT NULL,
  TITLE varchar(255),
  UPDATEABLE boolean,
  UPDATED timestamp,
  OWNER bigint,
  CONSTRAINT FKSYWNJ64P6GFA8FLT3K9135X5F FOREIGN KEY (SENTIMENT_MODEL) REFERENCES MODELS (ID),
  CONSTRAINT FKRVNMMUK5EVNCOPASQ4KM1CQ88 FOREIGN KEY (OWNER) REFERENCES ACCOUNTS (ID)
);

DROP TABLE IF EXISTS SEARCH_EXTRAPARAMETERS;
CREATE TABLE SEARCH_EXTRAPARAMETERS
(
