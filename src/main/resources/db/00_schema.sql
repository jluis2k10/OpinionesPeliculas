...
CREATE TABLE Models (
  ...
  PRIMARY KEY (id),
  UNIQUE (name),
  CONSTRAINT FKQS76ALG419USE8XSX7OK94PFD FOREIGN KEY (OWNER) REFERENCES ACCOUNTS (ID)
);
...
(
  ...
  CONSTRAINT FKMNGNFYBA4I6U8IF71MIQ441N8 FOREIGN KEY (ACCOUNT_ID) REFERENCES ACCOUNTS (ID),
  CONSTRAINT FKERSONLWGKM1XPCTDE19J4LAC4 FOREIGN KEY (ROLE_ID) REFERENCES ACCOUNT_ROLES (ID)
);
