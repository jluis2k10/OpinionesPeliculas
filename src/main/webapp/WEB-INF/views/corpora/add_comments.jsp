...
<h4 class="mb-3">
    <a href="${path}/corpora" id="goBack" title="Atrás"><i class="fas fa-chevron-left"></i></a> Añadir nuevos comentarios<br/>
...
<form:form method="post" modelAttribute="sourceForm" action="${path}/corpora/add-comments/${corpus.id}" enctype="multipart/form-data">
